...
export default function UserContactCard() {
	...
	const contactFields = [
		{ label: "Phone", value: currentUser?.organized_data?.contact.driver_phone },
		{ label: "Email", value: currentUser?.organized_data?.contact.driver_email },
		{
			label: "Home Location",
			value: currentUser?.organized_data?.contact.home_location,
		},
		{ label: "City", value: currentUser?.organized_data?.contact.city },
		{ label: "State", value: currentUser?.organized_data?.contact.city_state_zip },
		{ label: "Date of Birth", value: currentUser?.organized_data?.contact.date_of_birth },
		{ label: "Languages", value: currentUser?.organized_data?.contact.languages },
		{ label: "Team Driver", value: currentUser?.organized_data?.contact.team_driver.name },
		{
			label: "Preferred distance",
			value: currentUser?.organized_data?.contact.preferred_distance,
		},
	];
	...
	const emergencyContactFields = [
		{
			label: "Name",
			value: currentUser?.organized_data?.contact?.emergency_contact?.name,
		},
		{
			label: "Phone",
			value: currentUser?.organized_data?.contact?.emergency_contact?.phone,
		},
		{
			label: "Relation",
			value: currentUser?.organized_data?.contact?.emergency_contact?.relation,
		},
	];
