					...
					<article>
						...
						<div className="pb-6">
							...
							<p className="text-sm text-gray-500 dark:text-gray-400">
								...
								would like to add a new section labeled “Reports.” Before I proceed,
								I wanted to check if there’s any official guide or best practice you
								recommend for adding custom pages within the TailAdmin structure.
							</p>
						</div>
					</article>
					<article>
						...
						<div className="pb-6">
							...
							<p className="mb-5 text-sm text-gray-500 dark:text-gray-400">
								...
								pages like a &quot;Reports&quot; section, and it&apos;s quite
								straightforward. Here&apos;s a quick guide to help you get started:
							</p>
							<p className="text-sm text-gray-500 dark:text-gray-400">
