				...
				<div className=" p-5  xl:p-6">
					...
					<div className="text-sm text-gray-500 mb-7 dark:text-gray-400">
						...
						<p className="mb-4">
							...
							eleifend magna quis porta. ipsum dolor sit amet, consectetur adipiscing
							elit. Praesent ut rutrum mi. Aenean ac leo
						</p>
						...
						<p className="mb-4">
							...
							ornare massa. odales diam, quis rhoncus dolor aliquet a. Nulla a rhoncus
							lectus. In nunc neque
						</p>
