		...
		<div className="custom-scrollbar relative z-20 max-h-[50vh] space-y-7 overflow-y-auto pb-7">
				...
				<div className="max-w-3xl">
					...
					<div className="mt-3">
						...
						<p className="mt-3 text-sm leading-5 text-gray-500 dark:text-gray-400">
							Here is the tall building with a sleek glass facade, as described. The
							structure features modern elements with reflective glass panels that
							shimmer beautifully under the sunlight.
						</p>
					</div>
				</div>
			</div>
			...
			<div className="mb-6 flex justify-start">
				<div className="max-w-3xl">
					...
					<div className="mt-3">
						<p className="mt-3 text-sm leading-5 text-gray-500 dark:text-gray-400">
							Here are two tall buildings with sleek glass facades, just as described.
							Both structures showcase modern design elements, glass panels that
