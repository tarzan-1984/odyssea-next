...
export async function POST(request: NextRequest) {
	try {
		...
		const hasUserDevice = body.hasUserDevice; // When true, backend returns only users with user_devices row
		...
		if (hasUserDevice) queryParams.append("hasUserDevice", "true");
