...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/v1/messages/archive/chat-rooms/${chatRoomId}/${year}/${month}/${day}/exists`,
      {
        method: 'GET',
        headers: {
    ...
    console.error('Error checking archived messages existence:', error);
    return NextResponse.json(
